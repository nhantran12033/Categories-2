...
namespace Categories.Migrations
{
    ...
    [Migration("20230710032626_TripExpense_Entity")]
    partial class TripExpenseEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Categories.Currencys.Currency", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppCurrencys", (string)null);
                });

            modelBuilder.Entity("Categories.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Categories.ExpenseCodes.ExpenseCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Categories.KindOfFALs.KindOfFAL", b =>
                {
                    ...
                    b.ToTable("AppKindOfFals", (string)null);
                });

            modelBuilder.Entity("Categories.LegalEntitys.LegalEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppLegalEntitys", (string)null);
                });
            ...
            modelBuilder.Entity("Categories.TripExpenses.TripExpense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTripExpenses", (string)null);
                });

            modelBuilder.Entity("Categories.Trips.Trip", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Categories.VATs.VAT", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Categories.Suppliers.Supplier", b =>
                {
                    b.HasOne("Categories.LegalEntitys.LegalEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Categories.TripExpenses.TripExpense", b =>
                {
                    b.HasOne("Categories.Trips.Trip", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Categories.Trips.Trip", b =>
                {
                    b.HasOne("Categories.Departments.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Categories.ExpenseCodes.ExpenseCode", null)
                        .WithMany()
                        .HasForeignKey("ExpenseCodeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
